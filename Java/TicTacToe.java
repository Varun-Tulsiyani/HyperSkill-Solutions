...
public class TicTacToe {
    ...
    public static String[][] getColumns(String[] gameState) {
        String[][] columns = new String[3][3];
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                columns[i][j] = gameState[i + 3 * j];
            }
        }
        return columns;
    }
    ...
    public static boolean isColumnOf(String player, String[] gameState) {
        return isLinesOf(player, getColumns(gameState));
    }
    ...
    public static boolean isColumnOfXs(String[] gameState) {
        return isColumnOf("X", gameState);
    }

    public static boolean isColumnOfOs(String[] gameState) {
        return isColumnOf("O", gameState);
    }
    ...
    public static boolean isXWins(String[] gameState) {
        return isRowOfXs(gameState) || isColumnOfXs(gameState) || isDiagonalOfXs(gameState);
    }

    public static boolean isOWins(String[] gameState) {
        return isRowOfOs(gameState) || isColumnOfOs(gameState) || isDiagonalOfOs(gameState);
    }
